    ...
    <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between py-6">
      ...
      <div>
        ...
        <p className="text-sm text-gray-500">
          <span className="text-gray-800 font-medium"> <Link to="/dashboard">Dashboard</Link> </span> <span className="text-gray-800 font-medium"> <Link to="/DashBoard/DashBoardProduct" > / Products </Link> </span>   / Add Product
        </p>
      </div>
